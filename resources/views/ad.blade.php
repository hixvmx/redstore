                        ...
                        <div class="details__row">
                            <table class="detailsTable">
                                <tr>
                                    ...
                                    <td class="que">{{ $ad->category->name }}</td>
                                </tr>
                                <tr>
                                    <td>التصنيف الفرعي</td>
                                    <td class="que">{{ $ad->sub_category->name }}</td>
                                </tr>
                                <tr>
                                    <td>الدولة</td>
                                    <td class="que">{{ $ad->country->name }}</td>
                                </tr>
                                <tr>
                                    <td>المدينة</td>
                                    <td class="que">{{ $ad->city->name }}</td>
                                </tr>
                                <tr>
                                    <td>الثمن</td>
                                    <td class="que">{{ $ad->price .' '. $ad->currency->name }}</td>
                                </tr>
                                <tr>
                                    <td>نوع المنتج</td>
                                    <td class="que">##</td>
                                ...
                                <tr>
                                    <td>تاريخ النشر</td>
                                    <td class="que">{{ $ad->created_at['date'] }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
